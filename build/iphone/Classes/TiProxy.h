...
//Rare exceptions to indicate a bug in the _louisdor_rolf_project_1 code (Eg, function that a subclass should have implemented)
...
/**
 The base class for Louisdor_Rolf_Project_1 proxies.
 */

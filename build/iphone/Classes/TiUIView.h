...
/**
 Base class for all Louisdor_Rolf_Project_1 views.
 @see TiViewProxy
 */
...
/**
 Whether or not a view not normally picked up by the Louisdor_Rolf_Project_1 view hierarchy (such as wrapped iOS UIViews) was touched.

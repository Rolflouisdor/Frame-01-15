...
//@interface Louisdor_Rolf_Project_1Object : NSObject
//@end

@interface Louisdor_Rolf_Project_1Object (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[Louisdor_Rolf_Project_1Object class]])
		{
			for (NSString *key in [[(Louisdor_Rolf_Project_1Object*)o modules] allKeys])
			{

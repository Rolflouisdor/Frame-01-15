...
// in simulator we redefine to format for Louisdor_Rolf_Project_1 Developer console
...
{\
	NSString * exceptionName = [@"org.louisdor_rolf_project_1." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.louisdor_rolf_project_1";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UILouisdor_Rolf_Project_1NativeItemNone = -1, 
	UILouisdor_Rolf_Project_1NativeItemSpinner = -2,
	UILouisdor_Rolf_Project_1NativeItemProgressBar = -3,
	
	UILouisdor_Rolf_Project_1NativeItemSlider = -4,
	UILouisdor_Rolf_Project_1NativeItemSwitch = -5,
	UILouisdor_Rolf_Project_1NativeItemMultiButton = -6,
	UILouisdor_Rolf_Project_1NativeItemSegmented = -7,
	
	UILouisdor_Rolf_Project_1NativeItemTextView = -8,
	UILouisdor_Rolf_Project_1NativeItemTextField = -9,
	UILouisdor_Rolf_Project_1NativeItemSearchBar = -10,
	
	UILouisdor_Rolf_Project_1NativeItemPicker = -11,
	UILouisdor_Rolf_Project_1NativeItemDatePicker = -12,
	
	UILouisdor_Rolf_Project_1NativeItemInfoLight = -13,
	UILouisdor_Rolf_Project_1NativeItemInfoDark = -14,
	
	UILouisdor_Rolf_Project_1NativeItemDisclosure = -15,
	
	UILouisdor_Rolf_Project_1NativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all Louisdor_Rolf_Project_1 instances of

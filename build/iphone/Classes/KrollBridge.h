...
@interface Louisdor_Rolf_Project_1Object : KrollCoverageObject {
#else
@interface Louisdor_Rolf_Project_1Object : KrollObject {
#endif
@private
...
extern NSString * Louisdor_Rolf_Project_1$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	Louisdor_Rolf_Project_1Object *_louisdor_rolf_project_1;
    KrollObject* console;
	BOOL shutdown;

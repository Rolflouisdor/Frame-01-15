...
/**
 The base class for all Louisdor_Rolf_Project_1 modules
 */
...
/**
 Louisdor_Rolf_Project_1 Platform calls this method on startup.
 */
-(void)startup;

/**
 Louisdor_Rolf_Project_1 Platform calls this method on shutdown.
 @param sender The sender of the event.
 */
-(void)shutdown:(id)sender;

/**
 Louisdor_Rolf_Project_1 Platform calls this method on suspend.
 @param sender The sender of the event.
 */
-(void)suspend:(id)sender;

/**
 Louisdor_Rolf_Project_1 Platform calls this method on entering background.
 @param sender The sender of the event.
 */
-(void)paused:(id)sender;

/**
 Louisdor_Rolf_Project_1 Platform calls this method on resume.
 @param sender The sender of the event.
 */
